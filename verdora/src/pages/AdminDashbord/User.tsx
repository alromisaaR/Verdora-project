      ...
      <div className="container-fluid p-2 p-md-4">
        ...
        {showForm && (
          <div
            ...
            style={{ borderRadius: 16, background: CARD_BG }}
          >
            <div
            ...
            >
              <h5 className="mb-0 fw-bold">
                {formType === "add" ? "Add Customer" : "Edit User"}
              </h5>
              <button
                onClick={closeForm}
          ...
          {[
            ...
            <div key={index} className="col-6 col-md-3">
              <div
                ...
                style={{ borderRadius: 12, background: CARD_BG }}
              >
        ...
        {/* Desktop Table */}
        <div
          className="d-none d-md-block card border-0 shadow-sm"
          style={{ borderRadius: 12, background: CARD_BG }}
        >
                      ...
                      <td className="px-4 py-3">
                        <span
                          style={{
                            ...
                            fontWeight: 500,
                            backgroundColor:
                              user.role === "admin" ? "#FFF9E6" : "#F2FFF2",
                            color:
                              user.role === "admin" ? "#8a6d00" : "#2f6f2f",
                          }}
                        >
                  ...
                  <div className="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <span
                      style={{
                        ...
                        backgroundColor:
                          user.role === "admin" ? "#FFF9E6" : "#F2FFF2",
                        color: user.role === "admin" ? "#8a6d00" : "#2f6f2f",
                        fontWeight: 500,
                        fontSize: "0.8rem",
                      }}
                    >
